...
2. `npm test` â€“ run all tests in watch mode (should fail unless you implement the app)
3. `npm start` â€“ serve the app at [http://localhost:3000/](http://localhost:3000/) (it automatically opens the app in your default browser)
